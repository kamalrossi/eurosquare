...
import eurosquare0 from "./image/eurosquare0.png";
import eurosquare1 from "./image/eurosquare1.png";
import eurosquare2 from "./image/eurosquare2.png";
          ...
          <Row>
            <Col lg="10">
              <div className="po_item">
                <img src={eurosquare2} alt="" />
                <div className="content">
                  <p>EuroSquare Admin Dashboard</p>
            ...
            <Col lg="10">
              <div className="po_item">
                <img src={eurosquare1} alt="" />
                <div className="content">
                  <p>EuroSquare Offer</p>
                  <a href="">view project</a>
                </div>
              </div>
            </Col>
